      ...
      <div className="w-full max-w-md px-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-slate-600 mb-1.5">Mot de passe</label>
        ...
        <p className="text-center text-xs text-slate-300 mt-6">LuxTalent Advisory Group — Système de pré-sélection CV</p>
      </div>
    </div>
  );
}